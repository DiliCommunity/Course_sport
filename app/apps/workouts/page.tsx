...
import { 
  ...
  CheckCircle2, AlertCircle, Info, Home, Building2, MapPin
} from 'lucide-react'
...
// Упражнения разделены по местам тренировок
const STRENGTH_EXERCISES = {
  gym: {
    amateur: [
      { name: 'Приседания со штангой', sets: 3, reps: '12-15', rest: '60 сек', notes: 'Фокус на технике' },
      { name: 'Жим лежа', sets: 3, reps: '10-12', rest: '60 сек' },
      { name: 'Тяга штанги в наклоне', sets: 3, reps: '10-12', rest: '60 сек' },
      { name: 'Жим гантелей сидя', sets: 3, reps: '10-12', rest: '60 сек' },
      { name: 'Подтягивания', sets: 3, reps: '8-10', rest: '60 сек' },
      { name: 'Румынская тяга', sets: 3, reps: '10-12', rest: '60 сек' },
      { name: 'Жим ногами', sets: 3, reps: '12-15', rest: '60 сек' },
      { name: 'Скручивания на скамье', sets: 3, reps: '15-20', rest: '45 сек' }
    ],
    athlete: [
  ...
  home: {
    amateur: [
      { name: 'Приседания с собственным весом', sets: 3, reps: '15-20', rest: '60 сек', notes: 'Фокус на технике' },
      { name: 'Отжимания', sets: 3, reps: '10-15', rest: '60 сек' },
      { name: 'Планка', sets: 3, reps: '30-60 сек', rest: '60 сек' },
      { name: 'Выпады', sets: 3, reps: '12 на каждую ногу', rest: '60 сек' },
      { name: 'Обратные отжимания', sets: 3, reps: '10-12', rest: '60 сек' },
      { name: 'Берпи', sets: 3, reps: '8-10', rest: '60 сек' },
      { name: 'Ягодичный мостик', sets: 3, reps: '15-20', rest: '45 сек' },
      { name: 'Скручивания', sets: 3, reps: '15-20', rest: '45 сек' }
    ],
    athlete: [
      { name: 'Приседания на одной ноге', sets: 4, reps: '8-10 на каждую', rest: '90 сек', notes: 'Пистолетик' },
      { name: 'Отжимания с паузой', sets: 4, reps: '12-15', rest: '90 сек' },
      { name: 'Планка с подъемом ног', sets: 4, reps: '45-60 сек', rest: '60 сек' },
      { name: 'Болгарские выпады', sets: 4, reps: '10 на каждую ногу', rest: '90 сек' },
      { name: 'Отжимания в стойке на руках', sets: 3, reps: '5-8', rest: '120 сек' },
      { name: 'Берпи с прыжком', sets: 4, reps: '12-15', rest: '60 сек' },
      { name: 'Ягодичный мостик на одной ноге', sets: 3, reps: '12 на каждую', rest: '60 сек' },
      { name: 'V-скручивания', sets: 4, reps: '15-20', rest: '45 сек' }
    ]
  },
  outdoor: {
    amateur: [
      { name: 'Приседания на скамейке', sets: 3, reps: '15-20', rest: '60 сек', notes: 'Используйте скамейку в парке' },
      { name: 'Отжимания на брусьях', sets: 3, reps: '8-12', rest: '60 сек' },
      { name: 'Подтягивания на турнике', sets: 3, reps: '6-10', rest: '60 сек' },
      { name: 'Выпады на траве', sets: 3, reps: '12 на каждую ногу', rest: '60 сек' },
      { name: 'Планка на траве', sets: 3, reps: '30-60 сек', rest: '60 сек' },
      { name: 'Берпи', sets: 3, reps: '8-10', rest: '60 сек' },
      { name: 'Скакалка', sets: 3, reps: '50-100 прыжков', rest: '60 сек' },
      { name: 'Скручивания на траве', sets: 3, reps: '15-20', rest: '45 сек' }
    ],
    athlete: [
      { name: 'Приседания с прыжком', sets: 4, reps: '12-15', rest: '90 сек', notes: 'Взрывная сила' },
      { name: 'Отжимания на брусьях с весом', sets: 4, reps: '8-12', rest: '90 сек' },
      { name: 'Подтягивания с весом', sets: 4, reps: '6-8', rest: '90 сек' },
      { name: 'Болгарские выпады', sets: 4, reps: '10 на каждую ногу', rest: '90 сек' },
      { name: 'Планка с подъемом ног', sets: 4, reps: '45-60 сек', rest: '60 сек' },
      { name: 'Берпи с прыжком', sets: 4, reps: '12-15', rest: '60 сек' },
      { name: 'Скакалка (двойные прыжки)', sets: 4, reps: '30-50 прыжков', rest: '60 сек' },
      { name: 'V-скручивания', sets: 4, reps: '15-20', rest: '45 сек' }
    ]
  }
}
...
const CARDIO_EXERCISES = {
  gym: {
    amateur: [
      { name: 'Беговая дорожка', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Умеренный темп' },
      { name: 'Велотренажер', sets: 1, reps: '30-40 мин', rest: '-', notes: 'Стабильный темп' },
      { name: 'Эллипс', sets: 1, reps: '25-35 мин', rest: '-', notes: 'Среднее сопротивление' },
      { name: 'Гребной тренажер', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Равномерный темп' },
      { name: 'Степпер', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Умеренная нагрузка' }
    ],
    athlete: [
      { name: 'Беговая дорожка (интервалы)', sets: 1, reps: '8x400м (1:1 отдых)', rest: 'Равный времени бега', notes: 'Высокая интенсивность' },
      { name: 'Темповый бег', sets: 1, reps: '20-30 мин', rest: '-', notes: '85-90% от максимума' },
      { name: 'Велотренажер (интервалы)', sets: 1, reps: '5x5 мин (2 мин отдых)', rest: '2 мин', notes: 'Высокая мощность' },
      { name: 'Гребной тренажер (интервалы)', sets: 1, reps: '4x5 мин (2 мин отдых)', rest: '2 мин', notes: 'Максимальная мощность' },
      { name: 'Спринты на дорожке', sets: 8, reps: '30 сек (30 сек отдых)', rest: '30 сек', notes: 'Максимальная скорость' }
    ]
  },
  home: {
    amateur: [
      { name: 'Бег на месте', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Умеренный темп' },
      { name: 'Скакалка', sets: 1, reps: '15-20 мин', rest: '-', notes: 'Равномерный ритм' },
      { name: 'Табата (любое упражнение)', sets: 1, reps: '20 мин', rest: '-', notes: '4 минуты работы' },
      { name: 'Подъем по лестнице', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Если есть лестница' },
      { name: 'Танцевальная аэробика', sets: 1, reps: '30-40 мин', rest: '-', notes: 'Под музыку' }
    ],
    athlete: [
      { name: 'Интервальный бег на месте', sets: 1, reps: '8x1 мин (1 мин отдых)', rest: '1 мин', notes: 'Высокая интенсивность' },
      { name: 'Скакалка (интервалы)', sets: 1, reps: '10x2 мин (30 сек отдых)', rest: '30 сек', notes: 'Высокая скорость' },
      { name: 'Табата комплекс', sets: 8, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: '8 раундов, 4 минуты' },
      { name: 'Подъем по лестнице (интервалы)', sets: 5, reps: '3 мин подъем (2 мин отдых)', rest: '2 мин', notes: 'Быстрый темп' },
      { name: 'HIIT комплекс', sets: 1, reps: '25-30 мин', rest: '-', notes: 'Высокая интенсивность' }
    ]
  },
  outdoor: {
    amateur: [
      { name: 'Бег трусцой', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Умеренный темп' },
      { name: 'Быстрая ходьба', sets: 1, reps: '30-45 мин', rest: '-', notes: 'Стабильный темп' },
      { name: 'Велосипед', sets: 1, reps: '30-40 мин', rest: '-', notes: 'Равномерный темп' },
      { name: 'Ходьба в гору', sets: 1, reps: '30-45 мин', rest: '-', notes: 'Умеренный наклон' },
      { name: 'Плавание (если есть водоем)', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Свободный стиль' }
    ],
    athlete: [
...
const HIIT_EXERCISES = {
  gym: {
    amateur: [
      ...
      { name: 'Прыжки на ящик', sets: 4, reps: '20 сек работа / 40 сек отдых', rest: '40 сек', notes: 'Высота 30-50 см' },
      { name: 'Спринт на дорожке', sets: 4, reps: '20 сек работа / 40 сек отдых', rest: '40 сек' }
    ],
    athlete: [
      ...
      { name: 'Спринт на дорожке', sets: 8, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Максимальная скорость' },
  ...
  home: {
    ...
    athlete: [
      { name: 'Бёрпи с прыжком', sets: 6, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Максимальная интенсивность' },
      { name: 'Табата (любое упражнение)', sets: 8, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: '8 раундов, 4 минуты' },
      { name: 'Прыжки на месте (максимум)', sets: 8, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Максимальная скорость' },
      { name: 'Горные альпинисты (быстро)', sets: 6, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Быстрый темп' },
      { name: 'Бёрпи + прыжок + отжимание', sets: 6, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Комплексное упражнение' }
    ]
  },
  outdoor: {
    amateur: [
      { name: 'Бёрпи', sets: 4, reps: '30 сек работа / 30 сек отдых', rest: '30 сек', notes: 'Умеренный темп' },
      { name: 'Прыжки на месте', sets: 4, reps: '30 сек работа / 30 сек отдых', rest: '30 сек' },
      { name: 'Спринт', sets: 4, reps: '20 сек работа / 40 сек отдых', rest: '40 сек' },
      { name: 'Прыжки на скамейку', sets: 4, reps: '20 сек работа / 40 сек отдых', rest: '40 сек', notes: 'Используйте скамейку в парке' },
      { name: 'Бег с высоким подниманием колен', sets: 4, reps: '30 сек работа / 30 сек отдых', rest: '30 сек' }
    ],
    athlete: [
      { name: 'Бёрпи с прыжком', sets: 6, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Максимальная интенсивность' },
      { name: 'Спринт', sets: 8, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Максимальная скорость' },
      { name: 'Прыжки на скамейку', sets: 6, reps: '20 сек работа / 10 сек отдых', rest: '10 сек', notes: 'Высота 50-70 см' },
      { name: 'Бег в гору (интервалы)', sets: 6, reps: '30 сек подъем (30 сек спуск)', rest: '30 сек', notes: 'Силовая выносливость' },
      { name: 'Фартлек (интервалы)', sets: 1, reps: '20-25 мин', rest: '-', notes: 'Переменный темп' }
    ]
  }
}
...
export default function WorkoutGeneratorPage() {
  ...
  const [workoutLocation, setWorkoutLocation] = useState<'gym' | 'home' | 'outdoor' | ''>('')
  ...
  const generateWorkoutPlan = () => {
    ...
    setTimeout(() => {
      ...
      for (let day = 1; day <= days; day++) {
        ...
        // Генерируем упражнения в зависимости от типа, места и возраста
        if (workoutType === 'strength') {
          const location = workoutLocation || 'gym' // По умолчанию зал
          const exercisePool = STRENGTH_EXERCISES[location]?.[level] || STRENGTH_EXERCISES.gym[level]
          ...
          const exerciseCount = userAge < 35 
            ...
            ? (level === 'amateur' ? 4 : 5)
            : (level === 'amateur' ? 3 : 4)
          // Перемешиваем и выбираем случайные упражнения из выбранной категории
          const shuffled = [...exercisePool].sort(() => Math.random() - 0.5)
          exercises = shuffled.slice(0, exerciseCount).map(ex => ({ ...ex }))
          ...
          const location = workoutLocation || 'gym' // По умолчанию зал
          const exercisePool = CARDIO_EXERCISES[location]?.[level] || CARDIO_EXERCISES.gym[level]
          ...
          const location = workoutLocation || 'gym' // По умолчанию зал
          const exercisePool = HIIT_EXERCISES[location]?.[level] || HIIT_EXERCISES.gym[level]
          // Перемешиваем и выбираем случайные упражнения
          const shuffled = [...exercisePool].sort(() => Math.random() - 0.5)
          exercises = shuffled.slice(0, level === 'amateur' ? 4 : 5).map(ex => ({ ...ex }))
          intensity = 'high'
          ...
          const location = workoutLocation || 'home' // Для йоги по умолчанию дома
          if (location === 'gym') {
            exercises = [
              { name: 'Хатха йога', sets: 1, reps: '30-40 мин', rest: '-', notes: 'Статические позы, используйте коврик' },
              { name: 'Виньяса флоу', sets: 1, reps: '25-35 мин', rest: '-', notes: 'Динамическая последовательность' },
              { name: 'Растяжка с ремнями', sets: 1, reps: '15-20 мин', rest: '-', notes: 'Используйте оборудование зала' }
            ]
          } else if (location === 'outdoor') {
            exercises = [
              { name: 'Йога на природе', sets: 1, reps: '30-40 мин', rest: '-', notes: 'Статические позы на траве' },
              { name: 'Виньяса флоу', sets: 1, reps: '25-35 мин', rest: '-', notes: 'Динамическая последовательность' },
              { name: 'Растяжка', sets: 1, reps: '15-20 мин', rest: '-', notes: 'Глубокое растягивание на свежем воздухе' }
            ]
          } else {
            exercises = [
          ...
          const location = workoutLocation || 'home' // Для восстановления по умолчанию дома
          if (location === 'gym') {
            exercises = [
              { name: 'Легкая ходьба на дорожке', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Медленный темп' },
              { name: 'Растяжка с ремнями', sets: 1, reps: '15-20 мин', rest: '-', notes: 'Статическая растяжка' },
              { name: 'Йога', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Восстановительная практика' }
            ]
          } else if (location === 'outdoor') {
            exercises = [
              { name: 'Легкая прогулка', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Медленный темп на свежем воздухе' },
              { name: 'Растяжка на траве', sets: 1, reps: '15-20 мин', rest: '-', notes: 'Статическая растяжка' },
              { name: 'Йога на природе', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Восстановительная практика' }
            ]
          } else {
            exercises = [
              { name: 'Легкая прогулка по дому', sets: 1, reps: '20-30 мин', rest: '-', notes: 'Медленный темп' },
    ...
    <main className="min-h-screen px-4 py-20">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          {/* Workout Location - показываем только если выбраны типы тренировок */}
          {selectedTypes.length > 0 && (
            <motion.div
              initial={{ opacity: 0, height: 0 }}
              animate={{ opacity: 1, height: 'auto' }}
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <Building2 className={`w-6 h-6 ${workoutLocation === 'gym' ? 'text-accent-electric' : 'text-white/60'}`} />
                  <span className={`font-medium text-sm ${
                    workoutLocation === 'gym' ? 'text-white' : 'text-white/60'
                  }`}>
                    Зал
                  </span>
                  {workoutLocation === 'gym' && (
                ...
                >
                  <Home className={`w-6 h-6 ${workoutLocation === 'home' ? 'text-accent-electric' : 'text-white/60'}`} />
                  <span className={`font-medium text-sm ${
                    workoutLocation === 'home' ? 'text-white' : 'text-white/60'
                  }`}>
                    Дома
                  </span>
                  {workoutLocation === 'home' && (
                ...
                >
                  <MapPin className={`w-6 h-6 ${workoutLocation === 'outdoor' ? 'text-accent-electric' : 'text-white/60'}`} />
                  <span className={`font-medium text-sm ${
                    workoutLocation === 'outdoor' ? 'text-white' : 'text-white/60'
                  }`}>
                    Улица
                  </span>
                  {workoutLocation === 'outdoor' && (
              ...
              {!workoutLocation && (
                <p className="text-yellow-400 text-sm mt-2 flex items-center gap-2">
                  <AlertCircle className="w-4 h-4" />
                  Выберите место тренировок для более точного подбора упражнений
                </p>
              )}
            </motion.div>
          )}
          ...
          <Button
            ...
            disabled={selectedTypes.length === 0 || generating || (level === 'athlete' && !sport) || !workoutLocation}
            className="w-full"
            size="lg"
