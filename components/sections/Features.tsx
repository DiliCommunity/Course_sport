...
const features = [
  {
    icon: Sparkles,
    title: 'Интерактивные мини-приложения',
    description: 'Калькуляторы, генераторы рецептов, трекеры прогресса и другие удобные инструменты',
    color: 'teal',
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    description: 'Возврат денег в течение 7 дней, если курс не подойдёт',
    color: 'teal',
  },
]
